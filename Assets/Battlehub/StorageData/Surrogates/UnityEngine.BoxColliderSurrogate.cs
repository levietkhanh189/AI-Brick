...
{
    [ProtoContract]
    [Surrogate(typeof(global::UnityEngine.BoxCollider), _PROPERTY_INDEX, _TYPE_INDEX)]
    public class BoxColliderSurrogate<TID> : ISurrogate<TID> where TID : IEquatable<TID>
    {   
        const int _PROPERTY_INDEX = 10;
        const int _TYPE_INDEX = 113;
        ...
        public ValueTask Serialize(object obj, ISerializationContext<TID> ctx)
        {
            ...
            var o = (global::UnityEngine.BoxCollider)obj;
        ...
        public ValueTask<object> Deserialize(ISerializationContext<TID> ctx)
        {
            ...
            var o = idmap.GetComponent<global::UnityEngine.BoxCollider, TID>(id, gameObjectId);
            o.center = center;
            o.size = size;
            o.enabled = enabled;
