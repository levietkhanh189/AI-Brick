...
{
    [ProtoContract]
    [Surrogate(typeof(global::UnityEngine.PhysicMaterial), _PROPERTY_INDEX, _TYPE_INDEX)]
    ...
    {   
        ...
        [ProtoMember(7)]
        public global::UnityEngine.PhysicMaterialCombine bounceCombine { get; set; }
        ...
        public ValueTask Serialize(object obj, ISerializationContext<TID> ctx)
        {
            ...
            var o = (global::UnityEngine.PhysicMaterial)obj;
        ...
        public ValueTask<object> Deserialize(ISerializationContext<TID> ctx)
        {
            ...
            var o = idmap.GetOrCreateObject<global::UnityEngine.PhysicMaterial>(id);
