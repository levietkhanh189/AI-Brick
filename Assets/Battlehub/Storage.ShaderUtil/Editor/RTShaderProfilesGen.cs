...
namespace Battlehub.Storage
{
    ...
    {
        public const string DataFolder = "Assets/Battlehub/StorageData";
        public const string GeneratedDataFolder = DataFolder + "/Generated";
        ...
        [MenuItem("Tools/Runtime Asset Database/Create Shader Profiles", priority = 20)]
        public static RTShaderProfilesAsset Generate()
        {
            RTShaderProfilesAsset asset = Create();
            string dir = GeneratedDataFolder;
