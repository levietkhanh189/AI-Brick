...
namespace Battlehub.Storage
{
    ...
    public abstract class DefaultModuleDependencies : ModuleDependencies<Guid, string>
    {
        ...
        public override IObjectEnumeratorFactory ObjectEnumeratorFactory
        { 
            get { return EnumeratorFactory; }
        }
        ...
        where TFID : IEquatable<TFID>
    {
        ...
        public virtual IObjectEnumeratorFactory ObjectEnumeratorFactory
        {
            get;
        }
        ...
        public IObjectTreeEnumerator AcquireEnumerator(object obj, Func<object, bool> filter = null)
        {
