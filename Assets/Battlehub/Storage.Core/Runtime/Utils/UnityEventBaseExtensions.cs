...
namespace Battlehub.Storage.UnityExtensions
{
    internal static class ReflectionHelper
    {
        ...
        internal static T GetValue<T>(this FieldInfo fieldInfo, object obj)
        {
            return (T)fieldInfo.GetValue(obj);
        }
    }

    public class UnityEventArgumentsCache
    {
        ...
        public void ReadFrom(object obj)
        {
            ...
            ObjectArgumentAssemblyTypeName = ReflectionHelpers.CleanAssemblyName(m_objectArgumentAssemblyTypeNameFieldInfo.GetValue<string>(obj));
        }
    ...
    public class UnityEventPersistentCall
    {
        private static bool m_isFieldInfoInitialized;
        ...
        public static UnityEventPersistentCall CreateNew()
        {
            return new UnityEventPersistentCall
            {
                ArgumentsCache = new UnityEventArgumentsCache(),
        ...
        internal static void Initialize(Type type)
        {
            ...
            m_isFieldInfoInitialized = true;
            UnityEventArgumentsCache.Initialize(m_argumentsFieldInfo.FieldType);
        }

        public UnityEventArgumentsCache ArgumentsCache
        {
            get;
            set;
        }
    ...
    public static class UnityEventBaseExtensions
    {
        ...
        static UnityEventBaseExtensions()
        {
            ...
            UnityEventPersistentCall.Initialize(m_callType);
        }

        public static void AddPersistentCall(this UnityEventBase obj, UnityEventPersistentCall call)
        {
            UnityEventPersistentCall[] calls = obj.GetPersistentCalls();
        ...
        public static UnityEventPersistentCall[] GetPersistentCalls(this UnityEventBase obj)
        {
            object persistentCalls = m_persistentCallGroupInfo.GetValue(obj);
            if (persistentCalls == null)
            {
                return new UnityEventPersistentCall[0];
            }
            ...
            UnityEventPersistentCall[] result = new UnityEventPersistentCall[list.Count];
            for (int i = 0; i < result.Length; ++i)
            {
                object call = list[i];
                if (call != null)
                {
                    UnityEventPersistentCall persistentCall = new UnityEventPersistentCall();
        ...
        public static void SetPersistentCalls(this UnityEventBase obj, UnityEventPersistentCall[] persistentCalls)
        {
            ...
            {
                object call = null;
                UnityEventPersistentCall persistentCall = persistentCalls[i];
