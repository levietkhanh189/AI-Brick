...
namespace Battlehub.Storage
{
    ...
    public static class IModuleDependencies
    {
        ...
        public static SafeRef<IObjectTreeEnumerator> AcquireEnumeratorRef<TID, TFID>(this IModuleDependencies<TID, TFID> storageDependenciess, object obj, Func<object, bool> filter = null)
            where TID : IEquatable<TID>
            where TFID : IEquatable<TFID>
        {
            return new SafeRef<IObjectTreeEnumerator>(storageDependenciess.AcquireEnumerator(obj, filter), storageDependenciess.ReleaseEnumerator);
        }
       ...
       where TFID : IEquatable<TFID>
    {
        ...
        IObjectEnumeratorFactory ObjectEnumeratorFactory
        {
            get;
        }
        ...
        IObjectTreeEnumerator AcquireEnumerator(object obj, Func<object, bool> filter = null);
