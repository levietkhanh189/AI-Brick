...
namespace Battlehub.Storage
{
    public class SurrogateAttribute : Attribute
    {
        ...
        public SurrogateAttribute(Type type, int propertyIndex, int typeIndex, bool enabled = true, bool enableUpdates = true, Type enumeratorType = null,  [System.Runtime.CompilerServices.CallerFilePath] string filePath = null)
        {
            Type = type;
