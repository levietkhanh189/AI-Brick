...
namespace Battlehub.Storage
{
        ...
        where TFID : IEquatable<TFID>
    {
        ...
        /// <param name="cloneSubAssets">If necessary, check whether the sub-assets referenced by the instance in its asset can be cloned.(default is false).</param>
        /// <returns>True if the instance can be detached, otherwise false.</returns>
        bool CanDetach(object instance, bool completely = true, bool cloneSubAssets = false);
        ...
        /// <param name="cloneSubAssets">Clone sub-assets referenced by an instance in its asset (meshes, materials, etc).(default is false).</param>
        /// <returns>A task representing the asynchronous operation.</returns>
        Task DetachAsync(object instance, bool completely = true, bool cloneSubAssets = false);
        ...
        /// Imports an external asset using the provided external asset object and associated information.
        /// </summary>
        /// <param name="externalAssetID">The unique asset identifier of the external asset</param>
        /// <param name="externalAsset">The external asset object to import.</param>
        /// <param name="externalAssetKey">The key or identifier for the external asset.</param>
        /// <param name="externalLoaderID">The unique identifier of the external asset loader to use.</param>
        /// <param name="fileID">The unique identifier of the file associated with the imported asset.</param>
        ...
        /// <param name="parentID">The identifier of the parent folder (default is the root).</param>
        /// <returns>A task representing the asynchronous operation.</returns>
        Task ImportExternalAssetAsync(TID externalAssetID, object externalAsset, string externalAssetKey, string externalLoaderID, TFID metaFileID, byte[] thumbnail = null, TFID thumbnailID = default, TFID dataFileID = default, TID parentID = default);
        ...
        /// <summary>
        /// Exports assets identified by the given array of asset identifiers to a specified output stream.
        /// </summary>
        /// <param name="assetIDs">An array of unique identifiers for the assets to export.</param>
        /// <param name="outFileID">The fileID of the file to which the assets will be exported.</param>
        /// <param name="includeDependencies">Determines whether to include asset dependencies in the export (default is true).</param>
        /// <returns>A task representing the asynchronous operation.</returns>
        Task ExportAssetsAsync(TID[] assetIDs, TFID outFileID, bool includeDependencies = true);

        /// <summary>
        /// Imports assets from a specified input stream.
        /// </summary>
        /// <param name="fileID">The fileID of archive from which the assets will be imported.</param>
        /// <returns>A task representing the asynchronous operation.</returns>
        Task ImportAssetsAsync(TFID fileID, bool reloadProject = true);
    }


    public interface IAssetDatabaseSerializer<TID>
    {
        /// <summary>
        ...
        /// <returns></returns>
        Task<TID> SerializeAsync(object obj, Stream stream);
        ...
        Task<object> DeserializeAsync(TID id, Stream stream);
    }
}