...
public class ImageGenerationDemo : MonoBehaviour {
    ...
    private void Start() {
        ...
        foreach (var size in Enum.GetNames(typeof(DalleParameters.Size))) _sizeDropdown.choices.Add(size);
        ...
        foreach (var quality in Enum.GetNames(typeof(DalleParameters.Quality))) _qualityDropdown.choices.Add(quality);
